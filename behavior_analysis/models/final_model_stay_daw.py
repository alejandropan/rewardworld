...
def trial_log_likelihood_stay(params, trial_data, Q, all_contrasts, all_posteriors,
    ...
    for i in range(2):
        Q[i, trial_choice] += contrast_posterior[i] * learning_rate * (received_reward - Q_w[i, trial_choice])
...
for i, mouse in enumerate(mice):
    psy.loc[psy['mouse_name'] == mouse, ['QL', 'QR', 'QRQL', 'QLL', 'QRL', 'QLR', 'QRR','pRight',
                                         'QL0', 'QR0', 'QLL0', 'QRL0', 'QLR0', 'QRR0', 'pRight0', 'QRQL0',
                                         'ITIQL', 'ITIQR', 'ITIQLL', 'ITIQRL', 'ITIQLR', 'ITIQRR',
                                         'ITIQL0', 'ITIQR0', 'ITIQRQL', 'ITIpRight',
                                         'ITIQLL0', 'ITIQRL0', 'ITIQLR0', 'ITIQRR0',
                                         'ITIpRight0', 'ITIQRQL', 'ITIQRQL0']] =\
    modelled_data.loc[modelled_data['mouse_name'] == mouse,
                          ['QL', 'QR', 'QRQL', 'QLL', 'QRL', 'QLR', 'QRR','pRight',
                                         'QL0', 'QR0', 'QLL0', 'QRL0', 'QLR0', 'QRR0', 'pRight0', 'QRQL0',
                                         'ITIQL', 'ITIQR', 'ITIQLL', 'ITIQRL', 'ITIQLR', 'ITIQRR',
                                         'ITIQL0', 'ITIQR0', 'ITIQRQL', 'ITIpRight',
                                         'ITIQLL0', 'ITIQRL0', 'ITIQLR0', 'ITIQRR0',
