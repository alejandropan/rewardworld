...
from behavior_analysis.models.nolaser_no_stay_no_vision.model import *
from behavior_analysis.models.nolaser_no_stay_no_vision.no_stay_functions import *
...
for i, mouse in enumerate(mice): 
    ...
    (best_x_stay, train_NLL_stay, buffer_NLL_stay, 
     buffer_x_stay) = optimizer_stay(data, initial_guess=[0.3,  0.2])
    
    cv_aic_stay = aic((session_neg_log_likelihood_stay(best_x_stay,
              *data))*-1,5)
    
   
    cv_LL_stay = (session_neg_log_likelihood_stay(best_x_stay, *data))*-1
    ...
    sim_data = generate_data_stay(simulate_data, learning_rate=best_x_stay[0], 
                                   beta=best_x_stay[1])
