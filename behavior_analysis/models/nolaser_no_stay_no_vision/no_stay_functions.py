            ...
            if os.path.exists(mouse_path):
                ...
                for d in dates:
                    ...
                    for ses in sessions:
                        ...
                        for Q in Q_files:
                            qfile = os.path.join(alf,Q+'nolaser_nostay_novision_ephysfit.npy')
...
def calculate_QL_QR(modelled_data, model_parameters, 
    ...
    for mouse in mice:
        ...
        _,acc,Q_L,Q_R, pRight = session_neg_log_likelihood_stay(params1, 
                *data,  accu=True, retrieve_Q=True, 
...
def generate_data_stay(data, learning_rate=0.3, beta=0.2, is_verbose=False, 
