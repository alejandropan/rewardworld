...
from behavior_analysis.models.novision_no_stay.model import *
from behavior_analysis.models.novision_no_stay.no_stay_functions import *
...
for i, mouse in enumerate(mice): 
    ...
    (best_x_stay, train_NLL_stay, buffer_NLL_stay, 
     buffer_x_stay) = optimizer_stay(data, initial_guess=[0.3, -1, 0.2])
    ...
    sim_data = generate_data_stay(data, all_contrasts, learning_rate=best_x_stay[0], 
                                  extraVal=best_x_stay[1], beta=best_x_stay[2])
