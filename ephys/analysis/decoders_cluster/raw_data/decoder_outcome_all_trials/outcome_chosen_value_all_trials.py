...
## Run decoder (linear) ##
##########################
run_decoder_for_session(area, alfio, regressed_variable, weights,all_alignment_times, etype = 'real')
t_limit = len(regressed_variable)
for n, null_ses in enumerate(null_sesssions):
    run_decoder_for_session(area, alfio, regressed_variable, weights,all_alignment_times, etype = 'null', n=n)