...
id_dict = pd.read_csv('/jukebox/witten/Alex/decoders_raw_results/decoder_output_rpe_outcome_forget/id_dict.csv')
...
smoothing=0
bin_size=0.1
output_folder = '/jukebox/witten/Alex/decoders_raw_results/decoder_output_rpe_outcome_forget'
