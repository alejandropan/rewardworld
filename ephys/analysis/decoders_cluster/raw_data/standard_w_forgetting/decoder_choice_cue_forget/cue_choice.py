...
id_dict = pd.read_csv('/jukebox/witten/Alex/decoders_raw_results/decoder_output_choice_cue_forget/id_dict.csv')
...
smoothing=0
bin_size=0.1
output_folder = '/jukebox/witten/Alex/decoders_raw_results/decoder_output_choice_cue_forget'
...
regressed_variable = [1*(np.copy(alfio.choice)>0)[trials_included.astype(int)], 1*(np.copy(alfio.choice)<1) #Contra choice is left, contra choice is right
