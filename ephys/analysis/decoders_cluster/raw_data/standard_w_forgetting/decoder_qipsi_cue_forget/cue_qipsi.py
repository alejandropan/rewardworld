...
id_dict = pd.read_csv('/jukebox/witten/Alex/decoders_raw_results/decoder_output_qipsi_cue_forget/id_dict.csv')
alignment_time = 'goCue_time'
output_folder = '/jukebox/witten/Alex/decoders_raw_results/decoder_output_qipsi_cue_forget'
