...
id_dict = pd.read_csv('/jukebox/witten/Alex/decoders_raw_results/decoder_output_outcome_outcome_forget/id_dict.csv')
...
smoothing=0
bin_size=0.1
output_folder = '/jukebox/witten/Alex/decoders_raw_results/decoder_output_outcome_outcome_forget'
...
## Run decoder (linear) ##
##########################
run_decoder_for_session_residual(c_neural_data, area, alfio, regressed_variable, weights, alignment_time, etype = 'real', output_folder=output_folder, decoder = 'logistic', lambdas='omit')
