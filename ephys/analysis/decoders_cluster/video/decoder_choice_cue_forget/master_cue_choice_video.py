...
print(subprocess.run(['sbatch --array=0-'+str(len(SESSIONS)-1)+' /jukebox/witten/Alex/PYTHON/rewardworld/ephys/analysis/decoders_cluster/video/decoder_choice_cue_forget/cue_choice_video.cmd'], shell=True))