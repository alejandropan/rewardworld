...
print(subprocess.run(['sbatch --array=0-'+str(len(SESSIONS)-1)+' /jukebox/witten/Alex/PYTHON/rewardworld/ephys/analysis/decoders_cluster/video/decoder_deltaq_cue_forget/cue_deltaq_video.cmd'], shell=True))