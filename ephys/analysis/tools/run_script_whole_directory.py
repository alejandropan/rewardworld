...
direcs = ['/Volumes/witten/Alex/Data/Subjects/fip_13/',
'/Volumes/witten/Alex/Data/Subjects/fip_14/',
'/Volumes/witten/Alex/Data/Subjects/fip_15/',
'/Volumes/witten/Alex/Data/Subjects/fip_16/',
'/Volumes/witten/Alex/Data/Subjects/fip_17/',
'/Volumes/witten/Alex/Data/Subjects/fip_20/',
'/Volumes/witten/Alex/Data/Subjects/fip_21/',
'/Volumes/witten/Alex/Data/Subjects/fip_22/',
'/Volumes/witten/Alex/Data/Subjects/fip_23/',
'/Volumes/witten/Alex/Data/Subjects/fip_24/',
'/Volumes/witten/Alex/Data/Subjects/fip_25/']

for topdir in direcs:
	os.chdir(topdir)
	all_subdirs = [x[0] for x in os.walk(topdir) if 'fp_data' in x[0]]

	for sdx, sessiondir in enumerate(all_subdirs):
		if 'fp_data' not in sessiondir: # Skip all directories that don't end in raw_video_data
			continue
		files = [f for f in listdir(sessiondir) if isfile(join(sessiondir, f))]
		if 'FP470_processed.csv' not in files:
			continue
		print('%d/%d %s' % (sdx, len(all_subdirs), sessiondir[:-12]), end=' ', flush=True)
