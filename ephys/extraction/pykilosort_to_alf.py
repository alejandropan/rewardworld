...
class FpgaTrials(BaseExtractor):
    ...
    def _extract(self, sync=None, chmap=None, **kwargs):
        ...
        bpod_trials, _ = biased_trials.extract_all(
            session_path=self.session_path, save=False, bpod_trials=bpod_raw, extra_classes=[Intervals, 
            Wheel, FeedbackType, ProbabilityLeft, Choice, ItiDuration,
...
if __name__ == "__main__":
    ...
    sorting_sync_and_alf(session_path, overwrite=False)
    move_phy_files(ses)
