...
ITI_CORRECT = 2  # how long the stim should stay visible after CORRECT choice
ITI_ERROR = 10  # how long the stim should stay visible after ERROR choice
# VISUAL STIM
