...
for i in range(sph.NTRIALS):  # Main loop
    ...
    #  =============================================================================
    left_choice = "freeze_reward" if tph.left_reward ==1 else "freeze_error"
    right_choice = "freeze_reward" if tph.right_reward ==1 else "freeze_error"
    # =============================================================================
    ...
    sma.add_state(
        state_name="stim_on",
        state_timer=0.1,
        output_actions=[("Serial1", bonsai_show_stim), ("BNC1", 255)],
        state_change_conditions={
    ...
    sma.add_state(
        ...
        state_change_conditions={
            "Tup": "no_go",
            tph.choice_right: right_choice,
            tph.choice_left: left_choice,
        },
    )
    ...
    sma.add_state(
        ...
        output_actions=[('BNC2', 3), ('BNC1', 255), tph.out_laser] if tph.opto_block == 1 else [('Valve1', 255), ('BNC1', 255)],
