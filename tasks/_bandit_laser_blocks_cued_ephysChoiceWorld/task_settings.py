...
REWARD_AMOUNT = 4  # (µl) Amount of reward to be delivered upon correct choice each trial (overwitten if adaptive ON)  # noqa
...
ITI_CORRECT = 4  # how long the stim should stay visible after CORRECT choice
ITI_ERROR = 4  # how long the stim should stay visible after ERROR choice
# VISUAL STIM
...
BLOCK_PROBABILITY_SET = [0.1, 0.7]
BLOCK_LEN_FACTOR = 20
BLOCK_LEN_MIN = 10
BLOCK_LEN_MAX = 30
OPTO_BLOCK_PROBABILITY =0.5
# POSITIONS
...
LASER_TONE_DURATION = 0.1  # Length of noise burst
LASER_TONE_FREQUENCY = 2000  # 5KHz
LASER_TONE_AMPLITUDE = 0.0272 # Length of noise burst
