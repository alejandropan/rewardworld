...
REWARD_AMOUNT = 1.5  # (Âµl) Amount of reward to be delivered upon correct choice each trial (overwitten if adaptive ON)  # noqa
...
QUIESCENT_PERIOD = 0.2  # + x, where x~exp(0.35), t â?? 0.2 <= R <= 0.5
...
BLOCK_PROBABILITY_SET = [0.5, 0.5, 0.5]
BLOCK_LEN_FACTOR = 60
BLOCK_LEN_MIN = 20
BLOCK_LEN_MAX = 100
# POSITIONS
...
# CONTRASTS
CONTRAST_SET = [0.25, 0.125, 0.0625, 0.]  # Full contrast set
